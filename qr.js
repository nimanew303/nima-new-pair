    ...
    const {
                ...
                if (connection == "open") {
                    ...
                    try {
                        ...
                        let desc = `*Hello there NIMA User! 👋🏻* 

> Do not share your session id with your gf 😂.

 *Thanks for using NIMA 🚩* 
...
https://github.com/OfficialKango/NIMA
...
{quoted:code })
                            ...
                            let desc = `*Don't Share with anyone this code use for deploy NIMA*\n\n ◦ *Github:* https://github.com/OfficialKango/NIMA`;
                            await sock.sendMessage(sock.user.id, {
text: desc,
contextInfo: {
externalAdReply: {
